            ...
            <div class="content-wrapper" style="margin-bottom: 30px;">
               ...
               <div class="content-body">
                  <div class="row match-height">
                     <div id="recent-appointments" class="col-xs-12">
                        <div class="card">
                           ...
                           <div class="card-content mt-1">
                              <div class="table-responsive">
                                 <table id="recent-orders-doctors" class="table table-hover table-xl mb-0">
                                    <thead>
                                       <tr>
                                          <th class="border-top-0">Enroll Date</th>
                                          ...
                                          <th class="border-top-0">Enroll price</th>
                                    ...
                                    <tbody>
                                       ...
                                       ->where([['course_subscriptions.user_id', Auth::user()->id], ['course_subscriptions.status', 'active'], ['events_natives.lang', json_decode(Auth::user()->settings)->locale]])
                           ...
                           <div class="card-content mt-1">
                              <div class="table-responsive">
                                 <table id="recent-orders-doctors" class="table table-hover table-xl mb-0">
                                    <thead>
                                       <tr>
                                          <th class="border-top-0">Date of purchase</th>
                                       ...
                                       <tr>
                                        ...
                                        ?>
                                         ...
                                         <td class="color-theme-green">
                                          ...
                                          <a href="admin/products-native/{{ $purchase->ProductsNative->id }}">{{ $purchase->ProductsNative->name }}</a>
                                        </td>
                             ...
                             <div class="card-content mt-1">
                                <div class="table-responsive">
                                   <table id="recent-orders-doctors" class="table table-hover table-xl mb-0">
                                      <thead>
                                         <tr>
                                            <th class="border-top-0">Subscription Date</th>
                                            <th class="border-top-0">Expiry Date</th>
                                            <th class="border-top-0">Days left</th>
