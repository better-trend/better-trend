...
MultiLang::routeGroup(function($router) {
	...
	Route::middleware(['direction'])->group(function(){
        ...
        Route::get('/listings/{id}/{type}', 'Frontend\IndexController@listings_bill');
        ...
        Route::get('/partners', 'Frontend\IndexController@partners');
		...
		//Buy Plan for School
		Route::any('/buy_plan', 'Frontend\IndexController@buy_plan');
		...
		Route::post('/find_user', 'Frontend\IndexController@findUser');

		Route::post('/createPDF', 'Frontend\IndexController@createPDF');
		...
		Route::post('/deleteEventUser', 'Frontend\IndexController@deleteEventUser');
		...
		Route::get('/admin/orderupdate', 'Voyager\VoyagerCommentsController@orderUpdatePayment');

		Route::get('/admin/orderupdateshippment', 'Voyager\VoyagerCommentsController@orderUpdateShippment');
		...
		//Copy record
        Route::get('/copy/{id}/{className}/{path}', 'Frontend\IndexController@copy');

		// test for mailing
		Route::get('/test', 'Frontend\IndexController@test');

        Route::get('/load-cities/{id}', 'Frontend\IndexController@loadCities');
