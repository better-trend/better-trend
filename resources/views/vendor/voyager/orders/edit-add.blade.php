                    ...
                    <form role="form"
                        ...
                        <div class="panel-body">
                            ...
                            @foreach($dataTypeRows as $row)
                                <?php if ($row->field != "product_quantity") :  ?>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="col-sm-12">
                                        ...
                                        <input type="text" name="product_quantity" class="form-control" value="<?= $edit ? $model->product_quantity : '' ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="col-sm-12">
                                        <label for="" class="control-label">Shippment</label>
                                        <select name="shippment" class="form-control">
