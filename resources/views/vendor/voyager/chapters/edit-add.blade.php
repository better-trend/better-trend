                    ...
                    <form role="form"
                        ...
                        <div class="panel-body">
                            ...
                            <?php
                                ...
                                $m = \App\Chapter::find($id);
                            ?>
                            <!-- <div class="row">
                                <div class="col-sm-12">
                                    <div class="col-sm-12">
                                        <label for="" class="control-label">Lesson hours</label>
                                        <input name="hours" placeholder="Lesson hours" type="text" value="{{ $m ? ($m->hours ? $m->hours : 0) : 0 }}" class="form-control">
                                    </div>
                                </div>
                            </div> -->
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="col-sm-12">
                                        ...
                                        <input name="sort" placeholder="Sort" type="text" value="{{ $m ? ($m->sort ? $m->sort : 0) : 0 }}" class="form-control">
                                    </div>
                                </div>
                            </div>
