            ...
            <div class="row">
               <div class="col-md-12">
                  <ol class="breadcrumb text-right text-black mb-0 mt-40">
                     ...
                     <li class="active text-gray-silver">@t('Electronic School')</li>
                  </ol>
                  <h2 class="title text-white">@t('Electronic School')</h2>
               </div>
            </div>
         </div>
      </div>
                  ...
                  <div class="tab-pane fade in active" id="tab4">
                     <div class="row mb-30">
                        <div class="col-md-12">
                           ...
                           <a href="{{ lang_url('allschools') }}" class="btn btn-dark btn-xl btn-blue pull-left"><i class="fa fa-plus"></i>&nbsp;&nbsp;@t('Review of Online Schools')</a>
                           <a href="{{ lang_url('all_tests') }}" class="ml-10 mb-10 btn btn-dark btn-xl btn-blue pull-left">@t('Exam results')</a>
                                 ...
                                 <tbody>
                                    <?php if (count($my_subscriptions) > 0): ?>
                                       ...
                                       <tr>
                                          ...
                                          <td class="color-theme-green font-weight-600">
