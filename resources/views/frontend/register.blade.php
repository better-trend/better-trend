   ...
   <section class="divider">
      <div class="container">
         <div class="row pt-30 <?= (request()->segments()[0] == "ar" ? "rtl" : "ltr") ?>">
            <div class="col-sm-12">
               <h5 class="text-theme-colored">@t("reg_msg")</h5>
            </div>
                        ...
                        <div class="col-md-12 col-sm-12">
                           <div class="col-sm-12 p-0">
                              <div class="form-group mb-30">
                                 ...
                                 <input id="name" class="form-control" placeholder="@t('Name')" type="text" name="name" value="{{ old('name') }}" size="20" required>
                              </div>
                           </div>
                           <div class="col-sm-12 p-0">
                              <div class="form-group mb-30">
                           ...
                           <div class="col-sm-12 p-0">
                              <div class="form-group mb-30">
                                 <label for="password">@t('Password') <span style="color: red;"> *</span></label>
                           ...
                           <div class="col-sm-12 p-0">
                              <div class="form-group mb-30">
                                 <label for="phone">@t('Mobile number') <span style="color: red;"> *</span></label>
                                 <input id="phone" class="form-control" type="text" placeholder="@t('Mobile number')" name="phone" value="{{ old('phone') }}" size="20" required>
                              </div>
                           </div>
                           <div class="col-sm-12 p-0">
                              <div class="form-group mb-30">
                                 <label for="country">@t('Country') <span style="color: red;"> *</span></label>
