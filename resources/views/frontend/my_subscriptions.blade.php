            ...
            <div class="row">
               <div class="col-md-12">
                  <ol class="breadcrumb text-right text-black mb-0 mt-40">
                     ...
                     <li class="active text-gray-silver">@t('My Packages')</li>
                  </ol>
                  <h2 class="title text-white">@t('My Packages')</h2>
               </div>
            </div>
         </div>
      </div>
            ...
            <div class="col-md-9 col-sm-9 col-xs-12">
               <div class="tab-content">
                  <div class="tab-pane fade in active" id="tab3">
                     <div class="row mb-30">
                        <div class="col-md-12">
                           <a style="<?= request()->segments()[0] == "ar" ?  "float:right!important" : "" ?>" href="{{ lang_url('plans_pricing') }}" class="btn btn-dark btn-xl btn-blue pull-left"><i class="fa fa-plus ml-10"></i>@t('Browse packages') </a>
                        </div>
                     </div>
                     <div class="row">
                        <div class="col-md-12">
                                    ...
                                    @if($my_subscriptions)
                                       ...
                                       <tr>
                                          ...
                                          <td class="color-theme-green font-weight-600">
                                             <?php if ($subscriptions->package_end_date < date("Y-m-d")) :?>
                                                @t('Expired')
                                             <?php else : ?>
