            ...
            <div class="row">
               <div class="col-md-12">
                  <ol class="breadcrumb text-right text-black mb-0 mt-40">
                     ...
                     <li class="active text-gray-silver">@t('Contact Us')</li>
                  </ol>
                  <h2 class="title text-white">@t('Contact Us')</h2>
               </div>
            </div>
         </div>
      </div>
      ...
      <div class="container" style="padding-top: 0">
         <div class="row pt-30 <?= (request()->segments()[0] == "ar" ? "rtl" : "ltr") ?>">
            <div class="col-md-8 col-sm-12">
               <p class="mb-0 color-dark-green font-18" style="margin-bottom: 20px!important;">@t('Please use this form to contact as or send an email to support@bettertrend.net')</p>
               <!-- contact Form -->
                     ...
                     <div class="col-md-12 col-sm-12">
                        <div class="col-sm-12 p-0">
                           <div class="form-group mb-30">
                              <label for="first_name">@t('First name') <span style="color: red;">*</span> </label>
                        ...
                        <div class="col-sm-12 p-0">
                           <div class="form-group mb-30">
                              <label for="mobile_Number">@t('Mobile Phone Number') <span style="color: red;">*</span> </label>
                        ...
                        <div class="col-sm-12 p-0">
                           <div class="form-group mb-30">
                              <label for="email">@t('An email address') <span style="color: red;">*</span>
                              </label>
                        ...
                        <div class="col-sm-12 p-0">
                           <div class="form-group mb-30">
                              ...
                              <textarea minlength="3" id="summernote" class="form-control" name="message" rows="10" cols="5" placeholder="@t('Message')" required></textarea>
                           </div>
                        </div>
