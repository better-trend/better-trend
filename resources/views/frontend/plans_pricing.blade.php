      ...
      <div class="container">
         <div class="row <?= (request()->segments()[0] == "ar" ? "rtl" : "ltr") ?>">
            <div class="col-xs-12 col-sm-12 col-md-12 mb-sm-30">
               <h2 class="mt-0 font-30 heading-title-spec">@t('Membership Packages')</h2>
            </div>
         </div>
         <div class="row <?= (request()->segments()[0] == "ar" ? "rtl" : "ltr") ?>">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 hvr-float-shadow mb-sm-30">
               ...
               <div class="bg-white border-1px p-30 pt-20 pb-20" style="min-height: 400px; height: auto; overflow: hidden">
                  <h3 class="package-type font-24 m-0 mb-20 color-theme-green text-center">{{ $plans->name }}</h3>
                  ...
                  <div class="col-sm-12" style="padding-left: 0">
                      <span style="font-size: 20px;">@t('Price'):</span>&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size: 23px; padding-bottom: 10px; margin-left: -10px" class="text-theme-colored"><?= $plans->price ?>$</span>
                  </div>
               </div>
               <form name="buy_req" id="buy_req" method="POST" action="{{ lang_url('buy_plan') }}" class="buy_req">
                  ...
                  <button class="btn btn-lg btn-theme-green text-uppercase btn-block pt-20 pb-20 btn-flat" type="submit">
                     <?php if (!$isAvailable[$plans->id]) : ?>
                        <span style="color: gray">@t('Already purchased all schools in this package')</span>
                     <?php else : ?>
                        @t('Subscribe')
                     <?php endif; ?>
               </button>
