        ...
        <div class="row">
          <div class="col-md-12">
            <ol class="breadcrumb text-right text-black mb-0 mt-40">
              ...
              <li class="active text-gray-silver">@t('Coaches')</li>
            </ol>
            <h2 class="title text-white">@t('Coaches')</h2>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row multi-row-clearfix">
        ...
        <div class="col-sm-6 col-md-4 mb-sm-30 sm-text-center mb-30">
          <div class="team maxwidth400">
            <a class="text-center" href="{{ lang_url('coach_profile/'.$coach->users->id) }}">
              <h4 class="text-center name color-dark-green mt-0 mb-5 font-20">{{ $coach->users->name }}  </h4>
            </a>
            <h5 class="text-center color-theme-green">{{ $coach->users->last_name }} </h5>
